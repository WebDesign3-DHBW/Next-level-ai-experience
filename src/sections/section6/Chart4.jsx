...
function Chart4() {
    am4core.ready(function() {
      ...
      var chart = am4core.create("chartdiv_sec6_4", am4charts.PieChart);
      ...
      title.text = "Sprach- oder Textverstehen";
      title.marginBottom = "5";
      title.marginTop = "20";

      }); // end am4core.ready()
  return <div id="chartdiv_sec6_4" style={{ width: "100%", height: "300px" }}></div>;
  }
